                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <input class="form-input" type="text" name="nombre" id="nombre" placeholder="Ingrese su nombre" title="Ingrese su nombre aquí" maxlength="60" required>
                                        </div>
                                        <div class="col">
                                            <label class="form-label "for="apellido">Apellido:</label> <br>
                                            <input class="form-input" type="text" name="apellido" id="apellido" placeholder="Ingrese su apellido" title="Ingrese su apellido aquí" maxlength="30" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col">
                                            <label class="form-label" for="mail">Mail:</label> <br>
                                            <input class="form-input" type="email" name="mail" id="mail" placeholder="Ingrese su mail" title="Ingrese su mail aquí" maxlength="60" required>
                                        </div>
                                        <div class="col">
                                            <label  class="form-label" for="problema">Motivo de contacto:</label> <br>
                                    ...
                                    <div class="row">
                                        <label class="form-label" for="carga">Cargar archivo:</label>
                                        <input class="form-input" id="carga" type="file" name="carga" required>
                                    </div>
                                    <div class="row">
